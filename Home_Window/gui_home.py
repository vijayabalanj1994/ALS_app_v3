...
class GuiHome(qtw.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.s_filter_slider.valueChanged.connect(self.update_cam_mask)
    ...
    def run_analysis(self):
        ...
        self.cam, self.reconstructed_image = extract_cam_and_image(model, image_tensor, class_idx)
        ...
        self.lb_focused_image.setPixmap(
            pixmap.scaled(
                self.lb_focused_image.size()
            )
        )


        self.lb_status.setText("Status: Analysis Completed.")
        self.lb_status.setStyleSheet("""
    ...
    def update_cam_mask(self):
        ...
        self.lb_focused_image.clear()
        self.lb_slider_value.setText(f"Focus Toggle - {self.s_filter_slider.value()}%")
    ...
    def clear_GUI(self):
        ...
        self.lb_focused_image.setText("Waiting for model to run...")
        ...
        self.lb_status.setText("Status: Waiting for Image")
        self.lb_status.setStyleSheet("""
